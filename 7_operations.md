...
- **Queuing (TUV — service Time · Utilization · Variability)** — utilization approaching 1 → exponentially longer waits; pooling always beats splitting
...
**3-sigma control limits:** Upper Control Limit (UCL) = μ + 3(σ/√n) · Lower Control Limit (LCL) = μ − 3(σ/√n). Sample mean outside = real process change.
